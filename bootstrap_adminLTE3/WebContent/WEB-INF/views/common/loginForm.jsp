...
<style>
#body {
	background-image:url("<%=request.getContextPath()%>/resources/images/building.jpg");
...
<body class="hold-transition login-page" id="body">
	<div class="login-box">
		<div class="login-logo card card-outline card-warning">
			<a href="<%=request.getContextPath()%>/resources/index2.html"><b>Admin</b>LTE</a>
		</div>
		<!-- /.login-logo -->
		<div class="card">
			<div class="card-body login-card-body">
				...
				<form action="<%=request.getContextPath()%>/resources/index3.html"
					method="post">
